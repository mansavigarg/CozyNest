    ...
    <div className=' container mx-auto grid grid-cols-1 md:grid-cols-4 gap-8 px-4 lg:px-0'>
            <div>
                ...
                <p className=' text-gray-500 mb-4'>
                    Be the first to hear about new porducts, exclusive events, and online offers.
                </p>
                ...
                <form className=' flex '>
                    ...
                    <button type='submit' className=' bg-black text-white px-6 text-sm rounded-r-md hover:bg-gray-800 transition-all'>Subscribe</button>
                </form>
            </div>
